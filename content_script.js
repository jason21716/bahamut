...
chrome.storage.local.get(null, function(item) {
    ...
    if (item['titleNumbers'] === true) {
        title_msgChange(NEW_TITLE, configArr['titleNumbersCheckNotice'], configArr['titleNumbersCheckSubscript'], configArr['titleNumbersCheckRecommend']);
    ...
    if (pageName[0] == "singleACMsg") {
        ...
        //增加JSON上傳功能
        if (configArr['uploadJsonKey'] !== null && configArr['uploadJsonKey'].length == 64) {
